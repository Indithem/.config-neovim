...
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>") --[[my notes:
               "n" stands for normal mode
      so, when we press Escape in normal mode, then that function gets called.
               <cmd>nohlsearch<CR> is responsible for removing the highlights
]]
